---
name: session-close
description: Use at the end of a working session to leave the repo in a clean, resumable state. Covers PLAN.md or the active plan, AGENTS.md, memory, git, and handoff.
---
...
Ask: *could a new session read the active plan + AGENTS.md and know exactly where to resume?*
